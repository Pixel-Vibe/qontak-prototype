...
-->
<template>
  <div :class="css({ h: '100svh', display: 'flex', flexDirection: 'column', bg: 'background.default', overflow: 'hidden' })">
      ...
      <MpFlex flex="1" justifyContent="center" alignItems="center" gap="2">
        <MpFlex alignItems="center" gap="2">
          <MpIcon
            ...
            color="icon.brand"
          />
          <MpText size="body-small" :weight="step === 1 ? 'semiBold' : 'normal'" :color="step === 1 ? 'text.default' : 'text.secondary'">
            Template setup
          </MpText>
        </MpFlex>
        ...
        <MpFlex alignItems="center" gap="2">
          ...
          <MpIcon
            ...
            color="icon.default"
          />
          <MpText size="body-small" :weight="step === 2 ? 'semiBold' : 'normal'" :color="step === 2 ? 'text.default' : 'text.secondary'">
            Content editing
          </MpText>
        </MpFlex>
      </MpFlex>
      ...
      <div :class="css({ maxW: '540px', mx: 'auto', pt: '8', pb: '12', px: '4' })">
        ...
        <MpBanner id="banner-template-info" variant="info">
          ...
          <MpBannerDescription id="banner-desc-info">
            Boost WhatsApp marketing campaign delivery and reliability with new Meta API, built for higher reach, smarter targeting, and better conversions.
          </MpBannerDescription>
        ...
        <MpText size="h2" weight="semiBold" :class="css({ mb: '1', mt: '6' })">Template setup</MpText>
        <MpText color="text.secondary" :class="css({ mb: '6' })">
          Fill template basic information, type and category.
        </MpText>

        <!-- Account -->
        <MpFormControl id="fc-account" is-required :is-invalid="submitted && !account" :class="css({ mb: '5' })">
        ...
        <!-- Template name -->
        <MpFormControl id="fc-template-name" is-required :is-invalid="submitted && !templateName" :class="css({ mb: '5' })">
          ...
          <MpInput id="input-template-name" v-model="templateName" placeholder="Enter template name" :maxlength="512" />
          <MpFormHelpText>Template name must be in lowercase, numbers and underscores</MpFormHelpText>
        ...
        <MpFormControl id="fc-type" :class="css({ mb: '5' })">
          ...
          <MpFlex direction="column" gap="3">
            <MpRadio id="type-campaign" value="campaign" v-model="selectedType">
              Campaign
            ...
            <MpRadio id="type-followup" value="followup" v-model="selectedType">
              Follow-up
              <template #description>
        ...
        <MpFormControl id="fc-category" :class="css({ mb: '5' })">
          ...
          <MpFlex direction="column" gap="3">
            <MpRadio id="cat-marketing" value="marketing" v-model="selectedCategory">
              Marketing
              <template #description>
        ...
        <!-- Language -->
        <MpFormControl id="fc-language" is-required :is-invalid="submitted && !language" :class="css({ mb: '5' })">
    ...
    <div v-else :class="css({ flex: 1, display: 'flex', overflow: 'hidden' })">
      ...
      <div :class="css({ flex: 1, overflowY: 'auto', px: '12', py: '8' })">
        <MpText size="h2" weight="semiBold" :class="css({ mb: '1' })">Content editing - Campaign</MpText>
        ...
        <MpFormControl id="fc-message" is-required :is-invalid="submitted && !messageBodyText">
          <MpFlex justifyContent="space-between" alignItems="center">
            ...
            <MpText size="body-small" color="text.secondary">{{ messageBodyText.length }}/{{ MESSAGE_MAX_LENGTH }}</MpText>
          </MpFlex>
        ...
        <div v-if="detectedVariables.length > 0" :class="css({ mt: '5' })">
          <MpText size="body-small" weight="semiBold" :class="css({ mb: '1' })">Variable content sample*</MpText>
          <MpText size="body-small" color="text.secondary" :class="css({ mb: '3' })">
            Add sample content to define this variable. Make sure your recipient list file includes a column that matches the variable number you've added in the template.
            <MpText as="a" href="#" color="text.link" is-text-link :class="css({ ml: '1' })">Learn about template variables</MpText>
          </MpText>
          <MpFlex
          ...
          >
            <div :class="css({
              w: '52px', flexShrink: 0,
              bg: 'background.stage', borderWidth: '1px', borderColor: 'border.default',
              borderRadius: 'md', px: '2', py: '1', textAlign: 'center',
            })">
            ...
            <MpInput
              ...
              @update:model-value="(v: string) => { variableSamples[n] = v }"
            />
          </MpFlex>
        </div>
      ...
      <!-- Right: Preview panel -->
      <div :class="css({
        w: '460px', flexShrink: 0,
        borderLeftWidth: '1px', borderColor: 'border.default',
        bg: 'background.stage', overflowY: 'auto', p: '6',
      })">
        ...
        <div class="wa-bg" :class="css({ borderRadius: 'lg', p: '4', minH: '320px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' })">
          <div :class="css({ bg: 'background.default', borderRadius: 'md', p: '3', maxW: '88%', boxShadow: 'sm' })">
            ...
            <div
              ...
              :class="css({ bg: 'background.stage', borderRadius: 'sm', mb: '2', h: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center' })"
            >
    ...
    <!-- ═════ Footer ═════ -->
    <footer :class="css({
      flexShrink: 0, borderTopWidth: '1px', borderColor: 'border.default',
      px: '6', h: '64px', display: 'flex', alignItems: 'center',
      justifyContent: 'flex-end', gap: '3', bg: 'background.default',
    })">
      ...
      <template v-else>
        ...
        <MpButton variant="primary" :is-loading="isSubmitting" @click="handleSubmit">Submit</MpButton>
      </template>
    </footer>
  </div>
</template>
